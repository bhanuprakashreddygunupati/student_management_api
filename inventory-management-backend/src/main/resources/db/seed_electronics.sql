...
--  Create Inventory Staff for Electronics Dept (Indian Profile)
-- Password: 'Staff@123'
...
--  Create Suppliers (Indian Operations)
...
--  Insert Products (2024-2025 Models) - Prices in INR (₹)
...
-- Link Products to Suppliers (ProductSupplier Join Table)
