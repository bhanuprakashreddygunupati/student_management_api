...
-- Get the Electronics Manager ID & Role
...
--  Cleanup old sales data to prevent duplicates
...
--  Create Customers (Using INSERT IGNORE to skip duplicates)
